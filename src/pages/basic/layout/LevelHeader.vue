        ...
        <div class="c-left">
            ...
            <ul class="products">
                <li :class="{'active': activeNo == item.no}" @click="handleChangeMenu(item)" v-for="(item, index) in menuList" :key="index">
                    <!-- <i class="iconfont icon-daohang-gongzuotai"></i> -->
    ...
    methods: {
        ...
        handleCommand (type) {
            if (type === 'exit') {
                ...
                let url = 'base/basic/enterprise';
                this.handleLinkTo(url);
            } else if (type === 'user') {
                let url = 'base/humanResources/account';
                this.handleLinkTo(url);
            }
        },
        setUser () {
        ...
        // 轮询
        intervalMessage () {
            // this._interMessage = setInterval(() => {
            //     setTimeout(() => {
...
<style rel="stylesheet/scss" lang="scss" scoped>
    ...
    .container {
        ...
        .c-right {
            ...
            height: 100%;
            @include flex(flex-start);
            ::v-deep .el-dropdown{ color: #fff; cursor: pointer; }
            ul {
                display: flex;
                li {
